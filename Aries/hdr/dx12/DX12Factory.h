...
public:
	...
	ID3D12CommandQueue *GetCommonCmdQ() const noexcept { return m_pCommonCmdQ.Get(); }

	virtual EAPIType GetApiType() const noexcept override { return EAPIType::DX12; }
...
protected:
	...
	ComPtr<ID3D12CommandQueue> m_pCommonCmdQ;
